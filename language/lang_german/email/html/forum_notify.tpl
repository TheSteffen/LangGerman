Subject: Benachrichtigen bei Antworten im Forum "{FORUM_NAME}" - {TOPIC_TITLE}
Charset: utf-8
<br /><font face="Verdana" size="2">
Hallo <b>{USERNAME}</b>,<br /><br />

<b>{POSTERNAME}</b> hat eine neue Antwort zum Thema "<b>{TOPIC_TITLE}</b>" im "<b>{FORUM_NAME}</b>" Forum bei <b>{SITENAME}</b> erstellt.<br /><br />
Nutze den folgenden Link um dir die Antworten anzuschauen:<br /><br />
