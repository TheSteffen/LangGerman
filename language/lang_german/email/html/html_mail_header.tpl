<html>
	<head>
		...
		<style type="text/css">
			...
			a:active {color: #ff1010; text-decoration: underline}
			a:visited {color: #334466; text-decoration: underline}

			.header { color: #dd3333;}
			.copyright { color: #224488;}
			...
			.post-text { width: 99%; float: left; clear: both; font-size: 12px; /*line-height: 1.2em;*/ padding-bottom: 3px; }
