...
<b>{POSTERNAME}</b> hat ein neues Thema mit dem Titel "<b>{TOPIC_TITLE}</b>" im Forum "<b>{FORUM_NAME}</b>" bei <b>{SITENAME}</b> erstellt.<br /><br />
Nutze den folgenden Link um dir das Thema anzuschauen:<br /><br />
