...
{POSTERNAME} hat auf das Thema "{TOPIC_TITLE}" im Forum "{FORUM_NAME}" bei {SITENAME} geantwortet.
Du kannst den folgenden Link benutzen, um direkt zum Thema zu gelangen:
